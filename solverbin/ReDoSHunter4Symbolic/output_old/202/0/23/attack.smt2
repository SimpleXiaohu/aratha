...
(assert (= prefix 
     (re.++  (str.to_re "\x77") (re.++  (str.to_re "\x65") (re.++  (str.to_re "\x62") (re.++  (str.to_re "\x4f") (re.++  (str.to_re "\x53") (re.++  (str.to_re "\x50") (re.++  (str.to_re "\x31") (re.++  (str.to_re "\x36") (re.++  (str.to_re "\x30") (re.++  (str.to_re "\x55") (re.++  (str.to_re "\x4e") (re.++  (str.to_re "\x41")  (str.to_re "\x2f")))))))))))))
))
(assert (= infix 
