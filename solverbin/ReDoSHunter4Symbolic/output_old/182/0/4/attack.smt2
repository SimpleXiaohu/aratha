...
(assert (= prefix 
     (re.++  (str.to_re "\x44") (re.++  (str.to_re "\x61") (re.++  (str.to_re "\x72") (re.++  (str.to_re "\x77") (re.++  (str.to_re "\x69") (re.++  (str.to_re "\x6e") (re.++  (str.to_re "\x2f") (re.++  (str.to_re "\x31") (re.++  (str.to_re "\x33")  (str.to_re "\x31"))))))))))
))
(assert (= infix 
