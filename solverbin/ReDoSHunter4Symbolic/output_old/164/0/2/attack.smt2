...
(assert (= prefix 
     (re.++  (re.++  (re.union  (re.++  (str.to_re "\x69") (re.++  (str.to_re "\x42") (re.++  (str.to_re "\x72") (re.++  (str.to_re "\x6f") (re.++  (str.to_re "\x77") (re.++  (str.to_re "\x73") (re.++  (str.to_re "\x65")  (str.to_re "\x72"))))))))  (re.++  (str.to_re "\x69") (re.++  (str.to_re "\x52") (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x50")  (str.to_re "\x50"))))))  (str.to_re "\x5c\x2f")) (re.+ (re.range "0" "9") ))
))
(assert (= infix 
