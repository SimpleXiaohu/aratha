...
(assert (= infix 
        (re.inter  (re.++ (re.*  (str.to_re "\x3b") ) (re.* re.allchar ))  (re.++ (re.*  (str.to_re "\x3b") ) (re.++  (re.union (re.union (str.to_re "\t") (str.to_re "\n") (str.to_re "\r") (str.to_re " "))  (str.to_re "\x3b")) (re.* re.allchar ))) )
))
(assert (= postfix 
