...
(assert (= prefix 
     (re.++  (re.++  (str.to_re "\x3b") (re.++ (re.*  (str.to_re "\x20") ) (re.++  (re.++  (str.to_re "\x49") (re.++  (str.to_re "\x2d") (re.++  (str.to_re "\x42") (re.++  (str.to_re "\x75") (re.++  (str.to_re "\x64") (re.++  (str.to_re "\x64")  (str.to_re "\x79")))))))  (re.union  (str.to_re "\x20")  (str.to_re "\x5f"))))) (re.+  (re.union  (str.to_re "\x5c\x2f")  (str.to_re "\x3b")) ))
))
(assert (= infix 
