...
(assert (= infix 
        (re.inter  (re.++ (re.* re.allchar ) (re.+ (re.range "0" "9") ))  (re.++ (re.* re.allchar ) (re.++  (re.++  (str.to_re "\x43") (re.++  (str.to_re "\x50") (re.++  (str.to_re "\x55") (re.++ (re.* re.allchar ) (re.++  (str.to_re "\x4f") (re.++  (str.to_re "\x53") (re.++  (re.union  (str.to_re "\x20")  (str.to_re "\x2b")) (re.++ (re.+ (re.range "0" "9") ) (re.++  (str.to_re "\x5f") (re.++ (re.+ (re.range "0" "9") )  (str.to_re "\x5f"))))))))))) (re.+ (re.range "0" "9") ))) )
))
(assert (= postfix 
