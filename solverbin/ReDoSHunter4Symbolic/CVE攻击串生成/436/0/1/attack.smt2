...
(assert (= prefix 
     (re.++  (str.to_re "\x3b") (re.++  (str.to_re "\x46") (re.++  (str.to_re "\x6c") (re.++  (str.to_re "\x79") (re.++  (str.to_re "\x5f") (re.++  (str.to_re "\x46")  (str.to_re "\x33")))))))
))
(assert (= infix 
