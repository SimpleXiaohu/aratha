...
(assert (= postfix 
         (re.++  (str.to_re "\x25ce") (re.++  (str.to_re "\x7e") (re.++  (str.to_re "\x25ce") (re.++  (str.to_re "\x7e") (re.++  (str.to_re "\x25ce") (re.++  (str.to_re "\x7e") (re.++  (str.to_re "\x25ce") (re.++  (str.to_re "\x7e")  (str.to_re "\x25ce")))))))))
))
