...
(assert (= infix 
         (re.++  (re.++  (str.to_re "\x26")  (re.++ "" (re.* "" ))))  (re.++  (re.union  (str.to_re "\x60") (re.union  (str.to_re "\x5c\x22") (re.union  (str.to_re "\x5c\x24")  (str.to_re "\x27")))) (re.++  (str.to_re "\x26") (re.++ (re.opt  (re.union  (str.to_re "\x60") (re.union  (str.to_re "\x5c\x22") (re.union  (str.to_re "\x5c\x24")  (str.to_re "\x27")))) ) (re.++  (str.to_re "\x26")  (re.++  re.allchar (re.*  re.allchar ))))))  (re.++  (re.++  (str.to_re "\x26")  (re.++ "" (re.* "" ))))  (re.++  (re.++  (str.to_re "\x5c\x5c")  (re.union  (str.to_re "\x60") (re.union  (str.to_re "\x5c\x22") (re.union  (str.to_re "\x5c\x24")  (str.to_re "\x27"))))) (re.++  (str.to_re "\x26")  (re.++ "" (re.* "" ))))
))
(assert (= postfix 
