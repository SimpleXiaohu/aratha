...
(assert (= prefix 
     (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x6e") (re.++  (str.to_re "\x64") (re.++  (str.to_re "\x72") (re.++  (str.to_re "\x6f") (re.++  (str.to_re "\x69") (re.++  (str.to_re "\x64") (re.++  (str.to_re "\x2d") (re.++  (str.to_re "\x30") (re.++ re.allchar (re.++  (str.to_re "\x30") (re.++  (str.to_re "\x2d") (re.++  (str.to_re "\x75") (re.++  (str.to_re "\x70") (re.++  (str.to_re "\x64") (re.++  (str.to_re "\x61") (re.++  (str.to_re "\x74") (re.++  (str.to_re "\x65") (re.++  (str.to_re "\x31") (re.++  (str.to_re "\x3b") (re.++  (str.to_re "\x20") (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x2d")  (str.to_re "\x3b")))))))))))))))))))))))))
))
(assert (= infix 
