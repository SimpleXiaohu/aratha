...
(assert (= prefix 
     (re.inter  (re.++ (re.+ (re.range "0" "9") ) (re.++ (re.*  (re.++  (str.to_re "\x5f") (re.+ (re.range "0" "9") )) ) (re.++ (re.opt  (str.to_re "\x5c\x2e") )  (re.++ (re.+ (re.range "0" "9") ) (re.*  (re.++  (str.to_re "\x5f") (re.+ (re.range "0" "9") )) )))))  (re.++ (re.union (re.range "a" "z") (re.range "A" "Z") (re.range "0" "9") (str.to_re "_")) (re.* (re.range "\x00" "\xffff") )))
))
(assert (= infix 
