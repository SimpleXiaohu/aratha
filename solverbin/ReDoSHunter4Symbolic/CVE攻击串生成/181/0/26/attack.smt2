...
(assert (= infix 
          (re.++  (re.++ (re.+  (re.union  (re.++  (str.to_re "\x27") (re.++ (re.*  (str.to_re "\x27") )  (str.to_re "\x27")))  (str.to_re "\x3e")) ) (re.+  (re.union  (re.++  (str.to_re "\x27") (re.++ (re.*  (str.to_re "\x27") )  (str.to_re "\x27")))  (re.++  (str.to_re "\x5c\x22") (re.++ (re.*  (str.to_re "\x5c\x22") )  (str.to_re "\x5c\x22")))) )) (re.++  (str.to_re "\x26") (re.++ (re.+  (re.union  (re.++  (str.to_re "\x27") (re.++ (re.*  (str.to_re "\x27") )  (str.to_re "\x27")))  (str.to_re "\x3e")) ) (re.++  (str.to_re "\x26") (re.++  (re.++  (str.to_re "\x5c\x22") (re.* re.allchar )) (re.++  (str.to_re "\x26")  (re.++ "" (re.* "" )))))))) 
))
(assert (= postfix 
