...
(assert (= prefix 
     (re.++  (str.to_re "\x50") (re.++  (str.to_re "\x6f") (re.++  (str.to_re "\x64") (re.++  (str.to_re "\x43") (re.++  (str.to_re "\x72") (re.++  (str.to_re "\x75") (re.++  (str.to_re "\x6e") (re.++  (str.to_re "\x63") (re.++  (str.to_re "\x68") (re.++  (str.to_re "\x65") (re.++  (str.to_re "\x72")  (str.to_re "\x31"))))))))))))
))
(assert (= infix 
