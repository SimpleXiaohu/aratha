...
(assert (= prefix 
     (re.++  (str.to_re "\x3b") (re.++  (str.to_re "\x49") (re.++  (str.to_re "\x42") (re.++  (str.to_re "\x75") (re.++  (str.to_re "\x64") (re.++  (str.to_re "\x64") (re.++  (str.to_re "\x79") (re.++  (str.to_re "\x43") (re.++  (str.to_re "\x6f") (re.++  (str.to_re "\x6e") (re.++  (str.to_re "\x6e") (re.++  (str.to_re "\x65") (re.++  (str.to_re "\x63")  (str.to_re "\x74"))))))))))))))
))
(assert (= infix 
