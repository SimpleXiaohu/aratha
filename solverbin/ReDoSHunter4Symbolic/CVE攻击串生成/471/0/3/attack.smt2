...
(assert (= prefix 
     (re.++  (re.++  (str.to_re "\x3b") (re.++ (re.*  (str.to_re "\x20") ) (re.++  (str.to_re "\x53") (re.++  (str.to_re "\x6d") (re.++  (str.to_re "\x61") (re.++  (str.to_re "\x72") (re.++  (str.to_re "\x74") (re.++  (str.to_re "\x50") (re.++  (str.to_re "\x61") (re.++  (str.to_re "\x64") (re.opt  (str.to_re "\x20") )))))))))))  (re.++  (re.++ (re.range "0" "9") (re.range "0" "9")) (re.*  (re.++ (re.range "0" "9") (re.range "0" "9")) )))
))
(assert (= infix 
