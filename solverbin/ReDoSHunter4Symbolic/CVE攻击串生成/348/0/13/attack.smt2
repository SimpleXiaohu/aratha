...
(assert (= prefix 
     (re.++  (str.to_re "\x56") (re.++  (str.to_re "\x65") (re.++  (str.to_re "\x72") (re.++  (str.to_re "\x73") (re.++  (str.to_re "\x69") (re.++  (str.to_re "\x6f") (re.++  (str.to_re "\x6e") (re.++  (str.to_re "\x2f") (re.++  (str.to_re "\x31") (re.++ re.allchar  (str.to_re "\x31")))))))))))
))
(assert (= infix 
