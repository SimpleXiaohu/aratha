...
(assert (= prefix 
     (re.++  (re.++  (str.to_re "\x72") (re.++  (str.to_re "\x67") (re.++  (str.to_re "\x62") (re.++  (str.to_re "\x5c\x28") (re.*  (re.union  (str.to_re "\x20") (re.union  (str.to_re "\x5c\x6e") (re.union  (str.to_re "\x5c\x72")  (str.to_re "\x5c\x74")))) ))))) (re.+ re.allchar ))
))
(assert (= infix 
