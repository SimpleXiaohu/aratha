...
(assert (= infix 
        (re.inter (re.*  (str.to_re "\x3b") )  (re.++ (re.*  (str.to_re "\x3b") ) (re.++  (re.++  (re.union (re.union (str.to_re "\t") (str.to_re "\n") (str.to_re "\r") (str.to_re " "))  (str.to_re "\x3b")) (re.++ (re.* re.allchar ) (re.++  (str.to_re "\x53") (re.++  (str.to_re "\x57") (re.++  (str.to_re "\x2d") (re.++  (str.to_re "\x56") (re.++  (str.to_re "\x65") (re.++  (str.to_re "\x72") (re.++  (str.to_re "\x73") (re.++  (str.to_re "\x69") (re.++  (str.to_re "\x6f") (re.++  (str.to_re "\x6e")  (str.to_re "\x5c\x2f"))))))))))))) (re.* re.allchar ))) (re.* re.allchar ) )
))
(assert (= postfix 
         (str.to_re "\x40")
))
