...
(assert (= infix 
        (re.inter  (re.++ (re.* re.allchar )  (str.to_re "\x53"))  (re.++  (str.to_re "\x57") (re.++  (str.to_re "\x2d") (re.++  (str.to_re "\x56") (re.++  (str.to_re "\x65") (re.++  (str.to_re "\x72") (re.++  (str.to_re "\x73") (re.++  (str.to_re "\x69") (re.++  (str.to_re "\x6f") (re.++  (str.to_re "\x6e") (re.++  (str.to_re "\x5c\x2f") (re.* re.allchar ))))))))))) )
))
(assert (= postfix 
