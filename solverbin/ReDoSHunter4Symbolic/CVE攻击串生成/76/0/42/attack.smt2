...
(assert (= infix 
         (re.++  (re.++ (re.*  (re.union  (str.to_re "\x20") (re.union  (str.to_re "\x0a") (re.union  (str.to_re "\x0d")  (str.to_re "\x09")))) ) (re.+  (re.union  (str.to_re "\x0a")  (str.to_re "\x0d")) )) (re.++  (str.to_re "\x26") (re.++  (re.++  (re.++ (re.*  (re.union  (str.to_re "\x20") (re.union  (str.to_re "\x0a") (re.union  (str.to_re "\x0d")  (str.to_re "\x09")))) ) (re.+  (re.union  (str.to_re "\x0a")  (str.to_re "\x0d")) )) (re.++  (re.*  (re.union  (str.to_re "\x20") (re.union  (str.to_re "\x0a") (re.union  (str.to_re "\x0d")  (str.to_re "\x09")))) ))) (re.++  (str.to_re "\x26") (re.++ (re.*  (re.union  (str.to_re "\x20") (re.union  (str.to_re "\x0a") (re.union  (str.to_re "\x0d")  (str.to_re "\x09")))) ) (re.++  (str.to_re "\x26") (re.+ re.allchar )))))))
))
(assert (= postfix 
