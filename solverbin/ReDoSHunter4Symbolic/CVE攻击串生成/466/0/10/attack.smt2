...
(assert (= prefix 
     (re.++  (re.++  (str.to_re "\x3b") (re.++ (re.*  (str.to_re "\x20") ) (re.++  (str.to_re "\x56") (re.++  (str.to_re "\x53") (re.range "\x36" "\x39"))))) (re.+ (re.range "0" "9") ))
))
(assert (= infix 
