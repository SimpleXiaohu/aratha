...
(assert (= prefix 
     (re.++  (re.++  (str.to_re "\x47") (re.++  (str.to_re "\x6f") (re.++  (str.to_re "\x6f") (re.++  (str.to_re "\x67") (re.++  (str.to_re "\x6c") (re.++  (str.to_re "\x65") (re.++  (str.to_re "\x62") (re.++  (str.to_re "\x6f") (re.++  (str.to_re "\x74")  (str.to_re "\x5c\x2f")))))))))) (re.+ (re.range "0" "9") ))
))
(assert (= infix 
