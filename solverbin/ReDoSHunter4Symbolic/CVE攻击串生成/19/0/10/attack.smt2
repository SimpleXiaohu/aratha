...
(assert (= infix 
        (re.inter  (re.++ (re.+ re.allchar ) (re.+  (re.++  (str.to_re "\x20") (re.++  (str.to_re "\x22") (re.++ (re.+ re.allchar )  (str.to_re "\x22")))) ))  (re.++ (re.+ re.allchar ) (re.++  (str.to_re "\x5c\x5d") (re.+  (re.++  (str.to_re "\x20") (re.++  (str.to_re "\x22") (re.++ (re.+ re.allchar )  (str.to_re "\x22")))) ))) )
))
(assert (= postfix 
         (re.inter  (re.++  (str.to_re "\x20") (re.++  (str.to_re "\x22") (re.++  (str.to_re "\x5c\x5d") (re.++  (str.to_re "\x20") (re.++  (str.to_re "\x22") (re.++  (str.to_re "\x00") (re.++  (str.to_re "\x22") (re.*  (re.union (re.union (str.to_re "\t") (str.to_re "\n") (str.to_re "\r") (str.to_re " ")) (re.inter re.allchar (re.comp (re.union (str.to_re "\t") (str.to_re "\n") (str.to_re "\r") (str.to_re " "))))) )))))))) (re.comp (re.+  (re.++  (str.to_re "\x20") (re.++  (str.to_re "\x22") (re.++ (re.+ re.allchar )  (str.to_re "\x22")))) )))
))
