...
(assert (= infix 
        (re.inter  (re.++ (re.+  (re.union (re.range "0" "9") (re.union (re.range "\x41" "\x5a") (re.range "\x61" "\x7a"))) ) (re.* re.allchar ))  (re.++ (re.+  (re.union (re.range "0" "9") (re.union (re.range "\x41" "\x5a") (re.range "\x61" "\x7a"))) ) (re.* re.allchar )) )
))
(assert (= postfix 
