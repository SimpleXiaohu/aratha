...
(assert (= prefix 
     (re.++  (str.to_re "\x4c") (re.++  (str.to_re "\x69") (re.++  (str.to_re "\x6e") (re.++  (str.to_re "\x75") (re.++  (str.to_re "\x78") (re.++  (str.to_re "\x2f") (re.++  (str.to_re "\x31") (re.++ re.allchar (re.++  (str.to_re "\x31") re.allchar)))))))))
))
(assert (= infix 
