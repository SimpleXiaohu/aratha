...
(assert (= prefix 
     (re.++  (re.++ (re.opt  (re.++  (str.to_re "\x3b")  (str.to_re "\x20")) ) (re.++  (str.to_re "\x53") (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x4d") (re.++  (str.to_re "\x53") (re.++  (str.to_re "\x55") (re.++  (str.to_re "\x4e") (re.++  (str.to_re "\x47")  (str.to_re "\x5c\x2d"))))))))) (re.+  (re.union  (str.to_re "\x5c\x2d") (re.union (re.range "0" "9") (re.union (re.range "\x41" "\x5a") (re.range "\x61" "\x7a")))) ))
))
(assert (= infix 
