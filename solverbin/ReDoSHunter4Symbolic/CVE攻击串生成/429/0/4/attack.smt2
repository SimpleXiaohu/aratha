...
(assert (= prefix 
     (re.++  (re.++  (str.to_re "\x3b") (re.++ (re.*  (str.to_re "\x20") ) (re.++  (re.union  (re.++  (str.to_re "\x45") (re.++  (str.to_re "\x78") (re.++  (str.to_re "\x63") (re.++  (str.to_re "\x69") (re.++  (str.to_re "\x74")  (str.to_re "\x65"))))))  (re.++  (str.to_re "\x49") (re.++  (str.to_re "\x43")  (str.to_re "\x45"))))  (re.union  (str.to_re "\x20")  (str.to_re "\x5f"))))) (re.+ (re.range "0" "9") ))
))
(assert (= infix 
