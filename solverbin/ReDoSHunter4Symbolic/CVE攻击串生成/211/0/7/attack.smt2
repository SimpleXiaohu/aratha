...
(assert (= prefix 
     (re.++  (str.to_re "\x70") (re.++  (str.to_re "\x68") (re.++  (str.to_re "\x69") (re.++  (str.to_re "\x6c") (re.++  (str.to_re "\x70") (re.++  (str.to_re "\x6f") (re.++  (str.to_re "\x64") (re.++  (str.to_re "\x64") (re.++  (str.to_re "\x65") (re.++  (str.to_re "\x72") (re.++  (str.to_re "\x2f") (re.++  (str.to_re "\x31") re.allchar))))))))))))
))
(assert (= infix 
