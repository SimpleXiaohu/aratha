...
(assert (= postfix 
         (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x25ce") (re.++  (str.to_re "\x0d") (re.++  (str.to_re "\x25ce") (re.++  (str.to_re "\x21") (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x20") (re.++  (str.to_re "\x25ce") (re.++  (str.to_re "\x0d") (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x25ce") (re.++  (str.to_re "\x0d") (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x25ce") (re.++  (str.to_re "\x0d") (re.++  (str.to_re "\x25ce") (re.++  (str.to_re "\x21") (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x20") (re.++  (str.to_re "\x25ce") (re.++  (str.to_re "\x0d") (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x25ce")  (str.to_re "\x0d"))))))))))))))))))))))))
))
