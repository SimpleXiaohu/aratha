...
(assert (= infix 
          (re.++  (re.++ (re.+  (str.to_re "\x5c\x22") ) (re.+  (re.++  (str.to_re "\x5c\x5c")  (re.union  (str.to_re "\x0a")  (str.to_re "\x0d"))) )) (re.++  (str.to_re "\x26") (re.++ (re.+  (str.to_re "\x5c\x22") ) (re.++  (str.to_re "\x26") (re.++  (re.++  (str.to_re "\x5c\x5c") (re.* re.allchar )) (re.++  (str.to_re "\x26")  (re.++ "" (re.* "" )))))))) 
))
(assert (= postfix 
