...
(assert (= infix 
         (re.++  (re.++  (str.to_re "\x26")  (re.++ "" (re.* "" )))) (re.inter  (re.++ (re.+  (str.to_re "\x5c\x22") ) (re.+  (re.++  (str.to_re "\x5c\x5c") re.allchar) )) (re.+  (re.++  (str.to_re "\x5c\x5c") re.allchar) )  (re.++  (str.to_re "\x5c\x5c") (re.* re.allchar )) )  (re.++  (re.++  (str.to_re "\x26")  (re.++ "" (re.* "" ))))
))
(assert (= postfix 
        (str.to_re "")
))
