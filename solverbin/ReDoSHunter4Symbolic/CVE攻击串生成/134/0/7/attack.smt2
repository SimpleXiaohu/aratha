...
(assert (= infix 
         (re.++  (re.++  (str.to_re "\x26")  (re.++ "" (re.* "" ))))  (re.++  (re.++ (re.+  (re.++  (str.to_re "\x5c\x5c")  (re.union  (str.to_re "\x0a")  (str.to_re "\x0d"))) ) (re.+  (str.to_re "\x5c\x22") )) (re.++  (str.to_re "\x26") (re.++ (re.+  (str.to_re "\x5c\x22") ) (re.++  (str.to_re "\x26") (re.++  (re.++  (str.to_re "\x5c\x5c") (re.* re.allchar )) (re.++  (str.to_re "\x26")  (re.++ "" (re.* "" )))))))) 
))
(assert (= postfix 
         (re.++  (str.to_re "\x22") (re.++  (str.to_re "\x21") (re.++  (str.to_re "\x0a") (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x22") (re.++  (str.to_re "\x21")  (str.to_re "\x0a")))))))
))
