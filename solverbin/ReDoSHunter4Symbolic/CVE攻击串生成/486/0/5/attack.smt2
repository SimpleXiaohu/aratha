...
(assert (= prefix 
     (re.++  (str.to_re "\x3b") (re.++  (str.to_re "\x20") (re.++  (str.to_re "\x53") (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x4d") (re.++  (str.to_re "\x53") (re.++  (str.to_re "\x55") (re.++  (str.to_re "\x4e") (re.++  (str.to_re "\x47")  (str.to_re "\x2d"))))))))))
))
(assert (= infix 
