...
(assert (= postfix 
         (re.inter  (re.++  (str.to_re "\x00") (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x6e") (re.++  (str.to_re "\x64") (re.++  (str.to_re "\x72") (re.++  (str.to_re "\x6f") (re.++  (str.to_re "\x69") (re.++  (str.to_re "\x64") (re.++  (str.to_re "\x00") (re.++  (str.to_re "\x47") (re.++  (str.to_re "\x53") (re.++  (str.to_re "\x41") (re.++  (str.to_re "\x5c\x2f") (re.++  (str.to_re "\x30") (re.++  (str.to_re "\x5c\x2e") (re.++  (str.to_re "\x30") (re.++  (str.to_re "\x5c\x2e") (re.++  (str.to_re "\x30") (re.*  (re.union (re.union (str.to_re "\t") (str.to_re "\n") (str.to_re "\r") (str.to_re " ")) (re.inter re.allchar (re.comp (re.union (str.to_re "\t") (str.to_re "\n") (str.to_re "\r") (str.to_re " "))))) ))))))))))))))))))) (re.comp (re.+ (re.range "0" "9") )))
))
