...
(assert (= prefix 
     (re.++  (re.++  (re.++  (str.to_re "\x44") (re.++  (str.to_re "\x61")  (str.to_re "\x72"))) (re.++  (re.++  (str.to_re "\x77") (re.++  (str.to_re "\x69")  (str.to_re "\x6e"))) (re.++  (str.to_re "\x5c\x2f") (re.++  (re.++  (str.to_re "\x31")  (str.to_re "\x32")) re.allchar)))) (re.+ (re.range "0" "9") ))
))
(assert (= infix 
