...
; (assert (and 
;     (= regex_exec_61 (str.++ regex_exec_62 regex_exec_63 regex_exec_64 regex_exec_75 regex_exec_82)) 
;     (str.in_re regex_exec_62 (str.to_re "")) 
;     (str.in_re regex_exec_63 (str.to_re "git+ssh://")) 
;     (and 
;         (ite (= regex_exec_64 "") (is-undefined regex_capture_65) (= regex_capture_65 (Str regex_exec_64))) ;regex_exec_64和regex_capture_65对应第一个捕获组([^:#]+:[^#]+(?:\.git)?)
;         (and 
;             (= regex_exec_64 (str.++ regex_exec_66 regex_exec_69 regex_exec_70 regex_exec_73)) 
;             (and 
;                 (= regex_exec_66 (str.++ regex_exec_67 regex_exec_68)) 
;                 (str.in_re regex_exec_67 (re.* (re.inter (re.union (re.range "\u{0}" "9") (re.range ";" "\u{ff}")) (re.union (re.range "\u{0}" """") (re.range "$" "\u{ff}"))))) 
;                 ; (str.in_re regex_exec_68 (re.inter (re.union (re.range "\u{0}" "9") (re.range ";" "\u{ff}")) (re.union (re.range "\u{0}" """") (re.range "$" "\u{ff}")))) 
;                 ; (str.in_re regex_exec_68 (re.inter (re.union (re.range "\u{0}" "9") (re.range ";" "\u{ff}")) (re.union (re.range "\u{0}" """") (re.range "$" "\u{ff}"))))
;             ) 
;             (str.in_re regex_exec_69 (str.to_re ":")) 
;             (and 
;                 (= regex_exec_70 (str.++ regex_exec_71 regex_exec_72)) 
;                 (str.in_re regex_exec_71 (re.* (re.union (re.range "\u{0}" """") (re.range "$" "\u{ff}")))) 
;                 ; (str.in_re regex_exec_72 (re.union (re.range "\u{0}" """") (re.range "$" "\u{ff}"))) 
;                 ; (str.in_re regex_exec_72 (re.union (re.range "\u{0}" """") (re.range "$" "\u{ff}")))
;             ) 
;             (and 
;                 (str.in_re regex_exec_74 (str.to_re ".git")) 
;                 (str.in_re regex_exec_73 (str.to_re ".git")) 
;                 (or 
;                     (= regex_exec_73 regex_exec_74) 
;                     (= regex_exec_73 "")
;                 )
;             )
;         )
;     ) 
;     (and 
;         (str.in_re regex_exec_76 (re.++ (str.to_re "#") (re.* re.allchar))) 
;         (and 
;             (= regex_exec_75 (str.++ regex_exec_77 regex_exec_78)) 
;             (str.in_re regex_exec_77 (str.to_re "#")) 
;             (and 
;                 (ite (= regex_exec_78 "") (is-undefined regex_capture_79) (= regex_capture_79 (Str regex_exec_78))) 
;                 (and 
;                     (= regex_exec_78 (str.++ regex_exec_80 regex_exec_81)) 
;                     (str.in_re regex_exec_80 (re.* re.allchar)) 
;                     (str.in_re regex_exec_81 (re.opt re.allchar)) 
;                     (str.in_re regex_exec_81 re.allchar)
;                 )
;             )
;         ) 
;         (or 
;             (= regex_exec_75 regex_exec_76) 
;             (= regex_exec_75 "")
;         )
;     ) 
;     (str.in_re regex_exec_82 (str.to_re ""))
; ))
...
;     (str.in_re regex_exec_63 (str.to_re "git+ssh://")) 
;     (and 
;         (ite (= regex_exec_64 "") (is-undefined regex_capture_65) (= regex_capture_65 (Str regex_exec_64))) 
;         (and 
;             (= regex_exec_64 (str.++ regex_exec_66 regex_exec_69 regex_exec_70 regex_exec_73)) 
;             (and 
;                 (= regex_exec_66 (str.++ regex_exec_67 regex_exec_68)) 
...
(declare-const regex_exec_83 String)

(declare-const regex_exec_84 String)

(declare-const regex_exec_85 String)

(declare-const regex_exec_86 String)

(declare-const regex_exec_87 String)

(declare-const regex_exec_88 String)

(declare-const regex_exec_89 String)

(declare-const regex_exec_90 String)

(declare-const regex_exec_91 String)

(declare-const regex_exec_92 String)

(declare-const regex_exec_93 String)

(assert (= (GetProperties 17) (store EmptyObject "0" (Just (Str regex_exec_83)))))

(check-sat)
(assert (and 
    (= regex_exec_83 (str.++ regex_exec_84 regex_exec_85 regex_exec_88 regex_exec_90 regex_exec_93)) 
    (str.in_re regex_exec_84 (re.++ (re.* re.allchar) (str.to_re ":"))) 
    (and 
        (= regex_exec_85 (str.++ regex_exec_86 regex_exec_87)) 
        (str.in_re regex_exec_86 (re.* (re.range "0" "9"))) 
        (str.in_re regex_exec_87 (re.range "0" "9")) 
        ; (str.in_re regex_exec_87 (re.range "0" "9"))
    ) 
    (and ;\/?
        ; (str.in_re regex_exec_89 (str.to_re "/")) 
        ; ; (str.in_re regex_exec_88 (str.to_re "/")) 
        ; (or 
        ;     (= regex_exec_88 regex_exec_89) 
        ;     (= regex_exec_88 "")
        ; )
        (str.in_re regex_exec_88 (re.opt (str.to_re "/")))
    ) 
    (and ; .*
        ; (= regex_exec_90 (str.++ regex_exec_91 regex_exec_92)) 
        ; (str.in_re regex_exec_91 (re.* re.allchar)) 
        ; ; (str.in_re regex_exec_92 (re.opt re.allchar)) 
        ; ; (str.in_re regex_exec_92 re.allchar)
        (str.in_re regex_exec_90 (re.* re.allchar))
    ) 
    (str.in_re regex_exec_93 (str.to_re ""))
))
...
(assert (and 
    ...
    (and 
        (ite (= regex_exec_64 "") (is-undefined regex_capture_65) (= regex_capture_65 (Str regex_exec_64))) 
        (and 
            (= regex_exec_64 (str.++ regex_exec_66 regex_exec_69 regex_exec_70 regex_exec_73)) ;[^:#]+:[^#]+(?:\.git)?
            (and 
                (= regex_exec_66 (str.++ regex_exec_67 regex_exec_68)) ;[^:#]+
                (str.in_re regex_exec_67 (re.* (re.inter (re.union (re.range "\u{0}" "9") (re.range ";" "\u{ff}")) (re.union (re.range "\u{0}" """") (re.range "$" "\u{ff}"))))) 
                (str.in_re regex_exec_68 (re.inter (re.union (re.range "\u{0}" "9") (re.range ";" "\u{ff}")) (re.union (re.range "\u{0}" """") (re.range "$" "\u{ff}")))) 
            ...
            (and 
                ...
                ;     (= regex_exec_73 "")
                ; )
                (str.in_re regex_exec_73 (re.opt (str.to_re ".git")))
            )
        )
    ) 
    (and 
        ...
        ;             ; ; (str.in_re regex_exec_81 (re.opt re.allchar)) 
        ;             ; ; (str.in_re regex_exec_81 re.allchar)
        ;             (str.in_re regex_exec_78 (re.* re.allchar))
        ;         )
        ;     )
        ; ) 
        ; (or 
        ...
        ; (str.in_re regex_exec_75 (re.opt (re.++ (str.to_re "#") (re.* re.allchar))))

        ; (str.in_re regex_exec_76 (re.++ (str.to_re "#") (re.* re.allchar)))
        (and 
            (= regex_exec_76 (str.++ regex_exec_77 regex_exec_78)) 
            (str.in_re regex_exec_77 (str.to_re "#")) 
            (and 
                (ite (= regex_exec_78 "") (is-undefined regex_capture_79) (= regex_capture_79 (Str regex_exec_78))) 
                (and 
...
(assert (not  
    (= 
        ...
        (GetField 
            (store 
                (store 
                    (store EmptyObject "0" (Just (Str regex_exec_61))) 
                    "1" 
                    (Just regex_capture_65)
                ) 
                "2" 
                (Just regex_capture_79)
            ) 
            (Num 1)
        )
    )
