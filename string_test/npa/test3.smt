...
(assert (not (not (= (Str regex_exec_83) (GetField (store (store (store EmptyObject "0" (Just (Str regex_exec_61))) "1" (Just regex_capture_65)) "2" (Just regex_capture_79)) (Num 1))))))
