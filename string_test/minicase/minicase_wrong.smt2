...
(assert (not (< (str.len (str var0)) 50)))
...
(assert (= (js.substring (str var0) 8 (Num 14)) "github"))
...
(assert (= (GetProperties 1) (store (store EmptyObject "0" (Just (Str regex_exec_0))) "1" (Just regex_capture_3))))

(assert (and
    (=
        regex_exec_0
        (str.++ regex_exec_1 regex_exec_2 regex_exec_6)
    )
    (str.in_re
        regex_exec_1
        (str.to_re "https://")
