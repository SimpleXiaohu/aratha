...
function _createForOfIteratorHelper(r, e) { var __temp_0__ = "undefined" != typeof Symbol; if (__temp_0__) __temp_0__ = r[Symbol.iterator]; var __temp_1__ = __temp_0__; if (!__temp_1__) __temp_1__ = r["@@iterator"]; var t = __temp_1__; if (!t) { if (Array.isArray(r) || (t = _unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t["return"] || t["return"](); } finally { if (u) throw o; } } }; }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
var fs = require("fs");
var _require = require("./bundles"),
  bundleTypes = _require.bundleTypes,
  moduleTypes = _require.moduleTypes;
var inlinedHostConfigs = require("./inlinedHostConfigs");
var FB_WWW_DEV = bundleTypes.FB_WWW_DEV,
...
var RENDERER = moduleTypes.RENDERER,
...
var forks = Object.freeze({
  ...
  "./packages/react-reconciler/src/ReactFiberConfig.js": function _packages_reactReconciler_src_ReactFiberConfigJs(bundleType, entry, dependencies, moduleType) {
    ...
    var _iterator = _createForOfIteratorHelper(inlinedHostConfigs),
      _step;
    try {
  ...
  "./packages/react-server/src/ReactServerStreamConfig.js": function _packages_reactServer_src_ReactServerStreamConfigJs(bundleType, entry, dependencies, moduleType) {
    ...
    // eslint-disable-next-line no-for-of-loops/no-for-of-loops
    var _iterator2 = _createForOfIteratorHelper(inlinedHostConfigs),
      _step2;
    try {
  ...
  "./packages/react-server/src/ReactFizzConfig.js": function _packages_reactServer_src_ReactFizzConfigJs(bundleType, entry, dependencies, moduleType) {
    ...
    // eslint-disable-next-line no-for-of-loops/no-for-of-loops
    var _iterator3 = _createForOfIteratorHelper(inlinedHostConfigs),
      _step3;
    try {
  ...
  "./packages/react-server/src/ReactFlightServerConfig.js": function _packages_reactServer_src_ReactFlightServerConfigJs(bundleType, entry, dependencies, moduleType) {
    ...
    // eslint-disable-next-line no-for-of-loops/no-for-of-loops
    var _iterator4 = _createForOfIteratorHelper(inlinedHostConfigs),
      _step4;
    try {
  ...
  "./packages/react-client/src/ReactFlightClientConfig.js": function _packages_reactClient_src_ReactFlightClientConfigJs(bundleType, entry, dependencies, moduleType) {
    ...
    // eslint-disable-next-line no-for-of-loops/no-for-of-loops
    var _iterator5 = _createForOfIteratorHelper(inlinedHostConfigs),
      _step5;
    try {
