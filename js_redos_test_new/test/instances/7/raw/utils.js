...
var _isArray = _interopRequireDefault(require("shared/isArray"));
...
function cleanForBridge(data, isPathAllowed) {
  ...
  if (data !== null) {
    ...
    var cleanedData = (0, _hydration.dehydrate)(data, cleanedPaths, unserializablePaths, path, isPathAllowed);
    return {
      data: cleanedData,
...
function copyWithDelete(obj, path) {
  ...
  var key = path[index];
  var updated = (0, _isArray["default"])(obj) ? obj.slice() : _objectSpread({}, obj);
  if (index + 1 === path.length) {
    if ((0, _isArray["default"])(updated)) {
...
function gt() {
  ...
  return (0, _compareVersions.compareVersions)(a, b) === 1;
}
function gte() {
  var a = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var b = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
