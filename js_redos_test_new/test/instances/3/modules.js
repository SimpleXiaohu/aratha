...
function getDependencies(_bundleType, entry) {
  ...
  var packageJson = _require(entry.replace(/(\/.*)?$/, '/package.json'));
...
function getForks(_bundleType, entry, _moduleType, _bundle) {
  var forksForBundle = {};
  Object.keys(_forks.forks).forEach(function (srcModule) {
    var dependencies = getDependencies(_bundleType, entry);
