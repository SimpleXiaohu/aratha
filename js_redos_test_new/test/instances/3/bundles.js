...
exports.moduleTypes = exports.bundleTypes = void 0;
...
var bundleTypes = exports.bundleTypes = {
...
var NODE_ES2015 = bundleTypes.NODE_ES2015,
  ESM_DEV = bundleTypes.ESM_DEV,
  ESM_PROD = bundleTypes.ESM_PROD,
  NODE_DEV = bundleTypes.NODE_DEV,
  NODE_PROD = bundleTypes.NODE_PROD,
  NODE_PROFILING = bundleTypes.NODE_PROFILING,
  BUN_DEV = bundleTypes.BUN_DEV,
  BUN_PROD = bundleTypes.BUN_PROD,
  FB_WWW_DEV = bundleTypes.FB_WWW_DEV,
  FB_WWW_PROD = bundleTypes.FB_WWW_PROD,
  FB_WWW_PROFILING = bundleTypes.FB_WWW_PROFILING,
  RN_OSS_DEV = bundleTypes.RN_OSS_DEV,
  RN_OSS_PROD = bundleTypes.RN_OSS_PROD,
  RN_OSS_PROFILING = bundleTypes.RN_OSS_PROFILING,
  RN_FB_DEV = bundleTypes.RN_FB_DEV,
  RN_FB_PROD = bundleTypes.RN_FB_PROD,
  RN_FB_PROFILING = bundleTypes.RN_FB_PROFILING,
  BROWSER_SCRIPT = bundleTypes.BROWSER_SCRIPT;
var moduleTypes = exports.moduleTypes = {
  // React
...
var ISOMORPHIC = moduleTypes.ISOMORPHIC,
  RENDERER = moduleTypes.RENDERER,
  RENDERER_UTILS = moduleTypes.RENDERER_UTILS,
  RECONCILER = moduleTypes.RECONCILER;
var bundles = [/******* Isomorphic *******/
{
  bundleTypes: [NODE_DEV, NODE_PROD, FB_WWW_DEV, FB_WWW_PROD, FB_WWW_PROFILING, RN_FB_DEV, RN_FB_PROD, RN_FB_PROFILING],
...
}, /******* React DOM Server *******/
{
  ...
  wrapWithModuleBoundaries: false,
  externals: ['react', 'react-dom'],
  babel: function babel(opts) {
    return Object.assign({}, opts, {
      plugins: opts.plugins.concat([[require.resolve('@babel/plugin-transform-classes'), {
        loose: true
      }]])
    });
  }
...
}, /******* React ART *******/
{
  ...
  babel: function babel(opts) {
    return Object.assign({}, opts, {
      // Include JSX
      presets: opts.presets.concat([require.resolve('@babel/preset-react'), require.resolve('@babel/preset-flow')]),
      plugins: opts.plugins.concat([[require.resolve('@babel/plugin-transform-classes'), {
        loose: true
      }]])
    });
...
{
  bundleTypes: [NODE_DEV, NODE_PROD, FB_WWW_DEV, FB_WWW_PROD, RN_FB_DEV, RN_FB_PROD, RN_FB_PROFILING],
  moduleType: ISOMORPHIC,
  entry: 'react-is',
  global: 'ReactIs',
  minifyWithProdErrorCodes: true,
...
{
  bundleTypes: [NODE_DEV, NODE_PROD, FB_WWW_DEV, FB_WWW_PROD, RN_FB_DEV, RN_FB_PROD],
  moduleType: ISOMORPHIC,
...
{
  bundleTypes: [NODE_DEV, NODE_PROD, FB_WWW_DEV, FB_WWW_PROD, FB_WWW_PROFILING],
  moduleType: ISOMORPHIC,
...
function getFilename(bundle, bundleType) {
  var name = bundle.name || bundle.entry;
  var globalName = bundle.global;
  ...
  switch (bundleType) {
    ...
    case BUN_DEV:
      return "".concat(name, ".development.js");
    case BUN_PROD:
      return "".concat(name, ".production.js");
    case ESM_DEV:
      return "".concat(name, ".development.js");
    case ESM_PROD:
      return "".concat(name, ".production.js");
    ...
    case NODE_PROD:
      return "".concat(name, ".production.js");
    case NODE_PROFILING:
      return "".concat(name, ".profiling.js");
    case FB_WWW_DEV:
    case RN_OSS_DEV:
    case RN_FB_DEV:
      return "".concat(globalName, "-dev.js");
    case FB_WWW_PROD:
    case RN_OSS_PROD:
    case RN_FB_PROD:
      return "".concat(globalName, "-prod.js");
    case FB_WWW_PROFILING:
    case RN_FB_PROFILING:
    case RN_OSS_PROFILING:
      return "".concat(globalName, "-profiling.js");
    case BROWSER_SCRIPT:
      return "".concat(name, ".js");
  }
}
