...
var settings = {
  website: {
    ...
    seoDescription: function seoDescription(_ref) {
      var snippetCount = _ref.snippetCount,
        websiteName = _ref.websiteName;
      return "Browse ".concat(snippetCount, " short code snippets for all your development needs on ").concat(websiteName, ".");
    }
  },
  owner: {
  ...
  repository: {
    ...
    snippetPrefix: 'https://github.com/Chalarangelo/30-seconds-of-code/blob/master/content/snippets'
  },
  license: {
